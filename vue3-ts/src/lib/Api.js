...
const Api = (document => {
  ...
  let util = {
    ajax(entity) {
      return new Promise((resolve, reject) => {
        ...
        log(entity.debug, '===>', url, '===>', queryString)
    ...
    jsonp(entity) {
      return new Promise((resolve, reject) => {
        ...
        // console.log(`正在定义回调函数，callbackID:${callbackID}`)
        ...
        window[callbackID] = response => {
          // console.log(`已开始执行回调函数，callbackID:${callbackID}`)
          resolve(response)
          // console.log(`已完成执行回调函数用户自定义部分，callbackID:${callbackID}`)
          if (timeOutId) clearTimeout(timeOutId)

          removeScript(callbackID)
          // console.log(`已移除script，callbackID:${callbackID}`)
        ...
        // console.log(`已插入script，callbackID:${callbackID}`
  ...
  let require = async (namespace = '', data = {}, config = {}) => {
    ...
    entity.input = data
    log(entity.debug, '------------' + namespace + '------------')
    log(entity.debug, entity.input)
    log(entity.debug, '----------------------------------------------------')
