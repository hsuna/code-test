 ...
 */
const modelBusiness = require("./threeBusiness.js");
        ...
        query
            ...
            .exec((res) => {
                modelBusiness.clipWebgl(res[0].node, photo).then((webglImg) => {
                    ...
                    const { width, height, pixelRatio } = self.data.sysInfo;
                    ...
                    wx.getImageInfo({ 
                        ...
                        success: (res) => {
                            ctx.drawImage(res.path, 0, 0, res.width * pixelRatio, res.height * pixelRatio, 0, 0, width * pixelRatio, height * pixelRatio);
                            ctx.draw(true);
        ...
        wx.getSystemInfo({
            success: result => {
                this.setData({
                    ...
                    "photoSize.width": result.windowWidth * 2,
                    "photoSize.height": result.windowHeight * 2,
                });
            },
        });
    },
