...
export default function (canvas, THREE) {
    ...
    var MODELS = [
        // { name: "Soldier" },
        { name: "02104771404616700426526542596" },
        // { name: "RiflePunch" },
    ];
    ...
    var UNITS = [
        {
            modelName: "02104771404616700426526542596",
            meshName: "mesh_0",
    ...
    function loadGltfModel(model, onLoaded) {
        ...
        loader.load("https://radar-static.amwaynet.com.cn/apps/super-radar/admin/v1/image/" + model.name + ".glb", function (gltf) {
